package com.booking.service.controllers;
...
import com.booking.service.models.CancellationDetails;
import com.booking.service.models.ConfirmationDetails;
import com.booking.service.models.PaymentDetails;
import com.booking.service.models.RoomDetails;
import com.booking.service.models.TransactionDetails;
import com.booking.service.services.BookingService;
import com.booking.service.services.RoomService;
...
public class BookingController {
	...
	@RequestMapping(path="/cancel",
			...
			produces=MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<CancellationDetails> cancelBooking(@Valid 
			@RequestParam("bookingId") int bookingId){
		
		bookingService.processAndCancelBooking(bookingId);
		
		
		// return the consolidated result
		String message = "Booking Deleted Successfully!";
		CancellationDetails cancellationMessage = new CancellationDetails(message);
